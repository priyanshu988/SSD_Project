                ...
                <div className='cardclass'>
                    <div className='card1'>
                        <div className="card-body">
                            ...
                            <hr className='line-form-top' />
                            <button className="btn btn-outline-dark" onClick={navigateToAdder}>Login</button>
                    ...
                    <div className='card1'>
                        <div className="card-body">
                            ...
                            <button className="btn btn-outline-dark" onClick={navigateToChecker}>Login</button>
